...
import markiMobile from '/product-xx99-mark-one-headphones/tablet/image-category-page-preview.jpg'
import markiTablet from '/product-xx99-mark-one-headphones/mobile/image-category-page-preview.jpg'
...
const YouMayAlsoLikeSection = () => {
  return (
    <div className='flex flex-col max-w-[1110px] mx-6 md:mx-10 lg:mx-auto'>
      ...
      <div className='flex flex-col gap-14 md:flex-row md:gap-4'>
        <div className='flex flex-col gap-8 items-center md:w-1/3'>
          <img className='rounded-lg md:hidden' src={markiMobile}/>
          <img className='hidden rounded-lg md:block lg:hidden' src={markiTablet} />
          <img className='hidden rounded-lg lg:block' src={markiDesktop} />
