...
import zx7Mobile from '/product-zx7-speaker/tablet/image-category-page-preview.jpg'
import zx7Tablet from '/product-zx7-speaker/mobile/image-category-page-preview.jpg'
    ...
    <section className='flex flex-col max-w-[1110px] mx-6 md:mx-10 lg:mx-auto'>
      ...
      <div className='flex flex-col gap-14 md:flex-row md:gap-4'>
        <div className='flex flex-col gap-8 items-center md:w-1/3'>
          <img className='rounded-lg md:hidden' src={zx7Mobile}/>
          <img className='hidden rounded-lg md:block lg:hidden' src={zx7Tablet} />
          <img className='hidden rounded-lg lg:block' src={zx7Desktop} />
          <p className='text-black text-[24px] uppercase font-bold tracking-[1.714px]'>Zx7 Speaker</p>
          <button
...
export default Zx9YouMayAlsoLike