...
const Mark2Features = () => {
  ...
  const mark2Data = audiophileData?.find(element => element.id === 4)

  return (
    <div className='flex flex-col gap-[88px] mx-6 md:mx-10 lg:flex-row lg:mx-auto max-w-[1110px]'>
      <div className='lg:w-[57%]'>
        ...
        <p 
          ...
          dangerouslySetInnerHTML={{ __html: mark2Data?.features.replace(/\n/g, '<br>') }} />
      </div>
      ...
      <div className='md:flex lg:flex-col'>
        ...
        <div className='pt-6 flex flex-col gap-2 md:pt-0 lg:pt-6'>
          ...
          <p className='text-[15px] leading-6 font-bold text-orange'>1x<span className='text-black font-medium opacity-50 ml-6'>Travel Bag</span></p>
        </div>
      </div>
    </div>
