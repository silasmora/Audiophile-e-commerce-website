...
import mark2Mobile from '/product-xx99-mark-two-headphones/tablet/image-category-page-preview.jpg'
import mark2Tablet from '/product-xx99-mark-two-headphones/mobile/image-category-page-preview.jpg'
    ...
    <section className='flex flex-col max-w-[1110px] mx-6 md:mx-10 lg:mx-auto'>
      ...
      <div className='flex flex-col gap-14 md:flex-row md:gap-4'>
        <div className='flex flex-col gap-8 items-center md:w-1/3'>
          <img className='rounded-lg md:hidden' src={mark2Mobile}/>
          <img className='hidden rounded-lg md:block lg:hidden' src={mark2Tablet} />
          <img className='hidden rounded-lg lg:block' src={mark2Desktop} />
          <p className='text-black text-[24px] uppercase font-bold tracking-[1.714px]'>Xx99 Mark ii</p>
          <button
...
export default Mark1YouMayAlsoLike